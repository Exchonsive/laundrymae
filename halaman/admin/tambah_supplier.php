...
<h1><strong><center>Tambah Supplier <i class="fa fa-user-plus"></i></center></strong></h1>
</div>
...
<?php
    if(isset($_POST['submit'])){ 
    	...
    	$alamat	= $_POST['alamat'];
        $telp	= $_POST['telp'];
    	$sql	= "INSERT INTO supplier (id_supplier,nama,alamat,telp) VALUES (NULL,'$nama','$alamat','$telp')";
...
?>
	<form role="form" method="post" action="" style="margin-left:3%; margin-right: 3%;">
	    ...
	    <div class="button" align="right">
	    	<button type="submit" name="submit" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Supplier</button>
